...
\author{Dimitrios Halatsis\thanks{Department of Bioengineering, Imperial College London, UK. Correspondence: \texttt{d.chalatsis22@imperial.ac.uk}. Code: \repo.}
  \and Noura Ezaz-Nikpay\thanks{Department of Computing, Imperial College London, UK.}
  \and Pranav Mamidanna\thanks{I-X Centre for AI in Science and Department of Bioengineering, Imperial College London, UK.}
  \and Dario Farina\thanks{Department of Bioengineering, Imperial College London, UK.}}
...
\begin{enumerate}
  \item \textbf{A synthesis method validated to first principles} (Sec.~\ref{sec:golden},
        \ref{sec:tierA}). The \emph{golden method} --- the spatial line-source integral
...
electrode, in mV per ampere injected, with the three-monopole fit the golden recipe uses
(dashed).}
\label{fig:mri}
\end{figure}
...
Golden MUAPs at the centre electrode of a small, a medium and a large unit ($1.7$, $28$ and
...
(golden and Butterworth-smoothed) and Farina generator at $2$--$8$~mm, each relative to
...
\item \textbf{MUAP scale and fibre geometry.} With the constant corrected and the grid
  ...
  $\sigma_{\mathrm{in}}\pi a^{2}$ caveat of Sec.~\ref{sec:golden}. What remains is
...
validation suite and wrote the paper. N.E.-N. developed the harmonic-streamline fibre
geometry. Contributions of P.M. and D.F. to be stated by the authors.
